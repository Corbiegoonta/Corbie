...
def create_url_vector(chunk_size:int, chunk_overlap:int, separators:list, urls:tuple):
...
def generate_query_and_result(openai_api_key:str, temperature:int, max_tokens:int, query:str, chunk_size:int, chunk_overlap:int, separators:list, *urls:str):
...
generate_query_and_result(openai_api_key, 0.9, 500, "What are the disadvantages of too much debt?", 1000, 200, ["\n\n", "\n", " "], "https://hbr.org/1978/09/new-framework-for-corporate-debt-policy")
# os.environ['OPENAI_API_KEY'] = openai_api_key
